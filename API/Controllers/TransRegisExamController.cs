...
{
    [RoutePrefix("TransRegisExam")]
    public class TransRegisExamController : ApiController
    {
        [Route("Get")]
        [HttpGet]
        public HttpResponseMessage Get(
            string transRegisExamID = null,
            string personID = null,
            string transProjectID = null)
        {
            DataSet ds = TransRegisExam.Get(transRegisExamID, personID, transProjectID);
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                list.Add(new
                {
                    transRegisExamID = dr["transRegisExamID"],
        ...
        public HttpResponseMessage Post()
        {
            ...
            DataTable dt = TransRegisExam.Set("POST", jsonData).Tables[0];
